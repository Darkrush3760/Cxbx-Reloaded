...
{
	// Silly hack 
	if ((uint32)FunctionAddr > 0x234300 && (uint32)FunctionAddr < 0x234309)
	{
		printf("HACK: IGNORING FALSE POSITIVE TO FIX FUTURAMA\n");
	}
	else
	{
		uint08 *FuncBytes = (uint08*)((uint32)FunctionAddr - g_XbeHeader->dwBaseAddr + g_XbeBuffer);
