        ...
        case WM_COMMAND:
        {
            switch(LOWORD(wParam))
            {
                ...
                case ID_HELP_HOMEPAGE:
                    ShellExecute(NULL, "open", "http://www.xohho.co.uk", NULL, NULL, SW_SHOWNORMAL);
                    break;
            }
...
void WndMain::StartEmulation(EnumAutoConvert x_AutoConvert, HWND hwndParent)
{
    ...
    // shell exe
    {
        ...
        {
            m_bCanStart = true;
            MessageBox(m_hwnd, "Emulation failed.\n\nTry converting again. If this message repeats, the Xbe is not supported.", "Cxbx-Reloaded", MB_ICONSTOP | MB_OK);
